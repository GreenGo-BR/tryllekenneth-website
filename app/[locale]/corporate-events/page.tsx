  ...
  return (
    <>
      ...
      <main className="min-h-screen">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-start">
              ...
              <div className="lg:pr-8">
                ...
                <p className="text-xl text-slate-700 mb-4 leading-relaxed font-semibold">
                  {locale === 'da' 
                    ? 'Professionel underholtning for firmaer og virksomhedsbegivenheder'
                    : 'Professional entertainment for companies and corporate gatherings'
                  }
                </p>
                <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                  {locale === 'da'
                    ? 'Premium underholtning til firmajulefester, konferencer, teambuilding og virksomhedsfester der skaber mindeværdige øjeblikke for medarbejdere'
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href={`/${locale}/contact`}>
                    <Button size="lg" className="btn-primary btn-lg">
                      {locale === 'da' ? 'Book Underholtning' : 'Book Entertainment'}
                    </Button>
                  </Link>
              ...
              <div className="relative group hidden lg:block">
                ...
                <div className="relative overflow-hidden rounded-3xl shadow-2xl group-hover:shadow-3xl transition-all duration-500 border border-blue-200/30 group-hover:border-blue-200/60 lg:max-w-[390px] lg:-ml-2">
              ...
              />
                ...
                <div className="mt-6 flex items-center justify-center gap-2 text-blue-700 font-semibold">
                  ...
                  <p className="text-sm">{locale === 'da' ? 'Premium Professionelt • Teambuilding • Underholtning' : 'Premium Professional • Team Building • Entertainment'}</p>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold mb-6 text-foreground magical-heading magical-text">
                {locale === 'da' ? 'Professionel Underholtning' : 'Professional Entertainment'}
              </h2>
              <p className="text-slate-700 mb-4 leading-relaxed font-medium">
                {locale === 'da'
                  ? 'TrylleKenneth tilbyder professionel trylleunderholtning specielt designet til firmaarrangementer og virksomhedsfester.'
              ...
              <p className="text-slate-700 leading-relaxed font-medium">
                {locale === 'da'
                  ? 'Fra små møder til store konferencer - vi tilbyder fleksibel underholtning der passer til dit arrangement.'
              ...
              <Card className="p-6 rounded-2xl border-2 border-teal-200/40 hover:border-teal-300/60 transition-all hover:shadow-lg hover:shadow-teal-200/40 magic-card-hover bg-gradient-to-br from-teal-50/50 to-white">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-700">{locale === 'da' ? 'Tilpasbar underholtning til forskellige arrangementtyper og størrelse' : 'Adaptable entertainment for different event types and sizes'}</p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-6 rounded-2xl border-2 border-cyan-200/40 hover:border-cyan-300/60 transition-all hover:shadow-lg hover:shadow-cyan-200/40 magic-card-hover bg-gradient-to-br from-cyan-50/50 to-white">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-700">{locale === 'da' ? 'Underholtning der engagerer og underholder dine medarbejdere og gæster' : 'Entertainment that engages and entertains your employees and guests'}</p>
                  </div>
                </div>
              </Card>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 text-center bg-gradient-to-r from-blue-600 via-teal-500 to-cyan-600 relative overflow-hidden">
          ...
          <div className="max-w-2xl mx-auto relative z-10">
            <h2 className="text-4xl font-bold mb-4 text-gray-900">
              {locale === 'da' ? 'Underholtning der Inspirerer' : 'Entertainment That Inspires'}
            </h2>
            <p className="text-lg text-slate-900 mb-8 leading-relaxed">
              {locale === 'da'
                ? 'Book TrylleKenneth til dit firmaarrangement og skab uforglemmelig underholtning for dine medarbejdere'
        ...
        <div className="h-16 bg-gradient-to-b from-blue-50/50 via-slate-50/30 to-slate-50 pointer-events-none"></div>
