  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-20 px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-5xl mx-auto relative z-10 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              {/* Left: Text Content */}
              <div>
                <h1 className="text-5xl sm:text-6xl font-bold mb-6 bg-gradient-to-r from-rose-600 via-pink-600 to-amber-600 bg-clip-text text-transparent">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href={`/${locale}/contact`}>
                    <Button size="lg" className="bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-700 hover:to-pink-700 text-white text-base font-semibold h-14 px-8 shadow-lg hover:shadow-xl transition-all">
                      {locale === 'da' ? 'Book Bryllupstrylleri' : 'Book Wedding Magic'}
                    </Button>
                  </Link>
                  <a href="tel:+4540852728">
                    <Button size="lg" className="border-2 border-rose-500 text-rose-600 hover:bg-rose-50 text-base font-semibold h-14 px-8 transition-all">
        ...
        {/* CTA Section - Premium */}
        <section className="py-20 px-4 sm:px-6 lg:px-8 text-center bg-gradient-to-r from-rose-600/95 via-pink-500/95 to-amber-600/95 relative overflow-hidden">
          ...
          <div className="max-w-2xl mx-auto relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href={`/${locale}/contact`}>
                <Button size="lg" className="bg-white text-rose-600 hover:bg-rose-50 text-base font-semibold h-14 px-8 shadow-lg hover:shadow-xl transition-all duration-300">
                  {locale === 'da' ? 'Book Bryllupstrylleri' : 'Book Wedding Magic'}
                </Button>
              </Link>
              <a href="tel:+4540852728">
