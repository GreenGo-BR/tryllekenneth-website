                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-2 rounded-lg border-2 border-border bg-background focus:outline-none focus:border-primary"
                      placeholder={locale === 'da' ? 'din@email.dk' : 'your@email.com'}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-2 rounded-lg border-2 border-border bg-background focus:outline-none focus:border-primary"
                      placeholder={locale === 'da' ? 'Dit telefonnummer' : 'Your phone number'}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2 rounded-lg border-2 border-border bg-background focus:outline-none focus:border-primary"
                    >
                      <option value="">{locale === 'da' ? 'Vælg arrangementstype' : 'Select event type'}</option>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-2 rounded-lg border-2 border-border bg-background focus:outline-none focus:border-primary"
                      placeholder={locale === 'da' ? 'Antal personer' : 'Number of guests'}
                      min="1"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder={locale === 'da' ? 'Fortæl mig om dit arrangement og eventuelle særlige ønsker...' : 'Tell me about your event and any special requests...'}
                    />
                  </div>
