  ...
  const galleryItems = [
    {
      ...
      description: locale === 'da' ? 'Interaktiv trylleoptræden for familier' : 'Interactive magic performance for families',
    },
    {
      id: 2,
      category: 'closeup',
    ...
    },
    {
      ...
      title: locale === 'da' ? 'Stand-up trylleri & comedy' : 'Stand-up Comedy Magic',
    ...
    },
    {
      ...
      title: locale === 'da' ? 'Piratunderholdning' : 'Pirate Entertainment',
      description: locale === 'da' ? 'Temashow med comedy og trylleri' : 'Themed comedy and magic show',
    },
    {
      id: 6,
      category: 'children',
      ...
      description: locale === 'da' ? 'Udendørs trylleri for alle aldre' : 'Outdoor magic for all ages',
    },
    {
      id: 7,
      category: 'santa',
      ...
      title: locale === 'da' ? 'Julemandens julemagi' : 'Santa Christmas Magic',
    ...
    },
    {
      ...
      description: locale === 'da' ? 'Større illusioner og liveoptræden' : 'Large-scale illusion performance',
    },
    {
      id: 10,
      category: 'events',
      ...
      title: locale === 'da' ? 'Magic & Comedy-show' : 'Magic & Comedy Showcase',
      description: locale === 'da' ? 'Professionelt variety-show' : 'Professional variety show',
    },
    {
      id: 11,
      category: 'events',
      ...
      description: locale === 'da' ? 'Professionel optræden til events' : 'Professional event performance',
    },
    {
      id: 12,
      category: 'events',
      ...
      title: locale === 'da' ? 'Magic & Comedy-show' : 'Magic & Comedy Variety Show',
      description: locale === 'da' ? 'Live komedie og magisk begivenhedsopvisning' : 'Live comedy and magic event performance',
    },
    {
      id: 13,
      category: 'events',
      ...
      title: locale === 'da' ? 'Vintage Trylle-Show Plakat' : 'Vintage Magic Show Poster',
      description: locale === 'da' ? 'Nostalgisk klassisk dansk trylleplakat fra magiens guldalder' : 'Nostalgic classic Danish magic poster from the golden age of magic',
    },
  ];
